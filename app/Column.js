...
export default class {
  constructor({ geometry, gl, index, length, renderer, scene, screen, viewport, content, type }) {
    this.extra = 0
    ...
    this.content = content // Column content (HTML structure)
    this.type = type // 'left', 'middle', or 'right'
  ...
  renderLeftColumn(ctx, width, height) {
  ...
  renderMiddleColumn(ctx, width, height) {
  ...
  renderRightColumn(ctx, width, height) {
