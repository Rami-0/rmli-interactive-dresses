...
const fontPath = '/fonts/forma.json';
const src = '/fonts/forma.png';
...
export default class Number {
  ...
  constructor({ gl, plane, renderer, text }: { gl: WebGLRenderingContext | WebGL2RenderingContext; plane: any; renderer: any; text: number }) {
    AutoBind(this);
  ...
  async createMesh() {
    try {
      ...
      console.error('Failed to create number mesh:', error);
    }
  }
}
